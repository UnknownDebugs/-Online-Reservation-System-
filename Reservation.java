...
public class Main {
    ...
    public static void printCalendar(String monthName, int startDayOfWeek, int daysInMonth, String unavailableDates) {
        ...
        // Print empty cells for the days before the 1st of the month
        ...
        for (int day = 1; day <= daysInMonth; day++) {
            ...
            if (dayOfWeek == 7) {
                System.out.println("│");
                // Only print the separator line if there are more days to print
                if (day < daysInMonth) {
                    System.out.println("├────────────────────────────────────┤");
                }
                dayOfWeek = 1;
        ...
        // Print remaining empty cells to complete the last row
        if (dayOfWeek > 1) {
            while (dayOfWeek <= 7) {
                System.out.print("│     ");
                dayOfWeek++;
